...
import { View, Text, TextInput, StyleSheet, Image, TouchableOpacity,SafeAreaView,ScrollView } from 'react-native';
      ...
      <SafeAreaView>
       ...
       <View style={styles.row}>
         ...
         <View style={{marginStart:20}} >
           <Text style={{fontWeight:'bold', color:'#A30000', marginBottom:10}}> Song Title </Text>
         ...
         <View style={{marginStart:20}} >
           <Text style={{fontWeight:'bold', color:'#A30000', marginBottom:10}}> Add Contributions </Text>
...
/>
         ...
         <View style={{marginStart:20}} >
           <Text style={{fontWeight:'bold', color:'#A30000', marginBottom:10}}> Invite </Text>
