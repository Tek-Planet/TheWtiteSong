    ...
    <View style={{flex: 1}}>
      <DrawerContentScrollView {...props}>
        ...
        <View
          ...
          <Text style={styles.baseMenuText}>About Us</Text>
          <View style={styles.horizontalLine} />
          <Text style={styles.baseMenuText}>Help</Text>
          <View style={styles.horizontalLine} />
          <Text style={styles.baseMenuText}>Contact Us</Text>
          <View style={styles.horizontalLine} />
          <Text style={styles.baseMenuText}>Terms</Text>
          <View style={styles.horizontalLine} />
          <Text style={styles.baseMenuText}>Policy</Text>
        </View>
